...
namespace BombermanUPC_Final {
	...
	/// <summary>
	/// Summary for FormUnJugador
	/// </summary>
	public ref class FormUnJugador : public System::Windows::Forms::Form
	{
	public:
		...
		Bitmap ^BmpDetonar = gcnew Bitmap("Explosion.png");
	...
	public:
		...
		FormUnJugador(string nom1, string nom2, int njugadores)
		{
			InitializeComponent();
			if (njugadores == 1) {
				oJuego = new CGestor(nom1, nom2, njugadores, 1);
			}
			else {
				oJuego = new CGestor(nom1, nom2, njugadores, 11);
			}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(FormUnJugador::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &FormUnJugador::timer1_Tick);
			// 
			// pictureBox1
			// 
			...
			this->Name = L"FormUnJugador";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BombermanUPC";
			this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &FormUnJugador::FormUnJugador_KeyDown);
			this->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &FormUnJugador::FormUnJugador_KeyUp);
...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
		...
		if (oJuego->Get_NJugadores() == 1) {
			...
			oJuego->Dibuja_Nivel(buffer, Bsolido, BDestructible, BBorde, BPasto);
	...
	private: System::Void FormUnJugador_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
		switch (e->KeyCode)
		{
		case Keys::Up:
	...
	private: System::Void FormUnJugador_KeyUp(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
